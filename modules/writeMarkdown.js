...
// ToDo, remove the empty lines generated when a specific section 
// is omitted. 
const generateMarkdown = (answers) =>
	`# ${answers.title}

## Description
${answers.description.trimEnd()}

${generateLicense(answers.license).trimEnd()}

## Table of contents
${generateTOC(answers)}

${generateSection(`Installation`, answers.installSection, answers.installation).trimEnd()}

## How to use
${answers.usage}

${generateSection(`How to contribute`, answers.contributeSection, answers.contribution).trimEnd()}

${generateSection(`How to test`, answers.testingSection, answers.testing).trimEnd()}
